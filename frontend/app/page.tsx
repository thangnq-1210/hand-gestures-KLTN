    ...
    <main className="min-h-screen bg-gradient-to-br from-background via-background to-secondary/10 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* <div className="mb-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-primary mb-3">Nhận Diện Cử Chỉ Tay</h1>
        ...
        <Card className="bg-card border-2 border-accent/20 shadow-lg">
          <div className="p-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-primary">Lịch Sử Nhận Diện</h2>
              {history.length > 0 && (
